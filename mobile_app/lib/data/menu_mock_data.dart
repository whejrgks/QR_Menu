  ...
  static List<MenuItem> getMenusWithOutOfStock() {
    return [
      ...
      MenuItem(
        ...
        price: 15000,
        imageUrl: 'https://images.unsplash.com/photo-1553979459-d2229ba7433w?w=400&h=300&fit=crop&q=80',
        allergens: ['밀', '우유', '대두'],
        isAvailable: true,
      ),
      MenuItem(
        ...
        price: 14000,
        imageUrl: 'https://images.unsplash.com/photo-1528607929212-4d8c0e1e4b0a?w=400&h=300&fit=crop',
        allergens: ['밀', '갑각류'],
        isAvailable: true,
      ),
      MenuItem(
      ...
      MenuItem(
        ...
        price: 12000,
        imageUrl: 'https://images.unsplash.com/photo-1626087927381-6c0a04f0a65b?w=400&h=300&fit=crop',
        allergens: ['밀', '우유'],
        isAvailable: true,
      ),
      MenuItem(
